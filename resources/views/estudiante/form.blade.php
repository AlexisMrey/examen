<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('creditos_est') }}
            {{ Form::text('creditos_est', $estudiante->creditos_est, ['class' => 'form-control' . ($errors->has('creditos_est') ? ' is-invalid' : ''), 'placeholder' => 'Creditos Est']) }}
            {!! $errors->first('creditos_est', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('correo') }}
